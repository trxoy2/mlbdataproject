...
def lookup_ozzie(ti):
    ...
    ozziealbiesStats = statcast_batter("2024-04-07", "2024-04-07", player_id = int(ozziealbiesID['key_mlbam'].values[0]))
...
def lookup_ronald(ti):
    ...
    ronaldacunaStats = statcast_batter("2024-04-07", "2024-04-07", player_id = int(ronaldacunaID['key_mlbam'].values[0]))
...
def lookup_olson(ti):
    ...
    mattolsonStats = statcast_batter("2024-04-07", "2024-04-07", player_id = int(mattolsonID['key_mlbam'].values[0]))
...
def lookup_riley(ti):
    ...
    austinrileyStats = statcast_batter("2024-04-07", "2024-04-07", player_id = int(austinrileyID['key_mlbam'].values[0]))
...
def lookup_ozuna(ti):
    ...
    marcellozunaStats = statcast_batter("2024-04-07", "2024-04-07", player_id = int(marcellozunaID['key_mlbam'].values[0]))
...
def lookup_harris(ti):
    ...
    michaelharrisStats = statcast_batter("2024-04-07", "2024-04-07", player_id = int(michaelharrisID['key_mlbam'].values[0]))
...
def lookup_murphy(ti):
    ...
    seanmurphyStats = statcast_batter("2024-04-07", "2024-04-07", player_id = int(seanmurphyID['key_mlbam'].values[0]))
...
def lookup_kelenic(ti):
    ...
    jarredkelenicStats = statcast_batter("2024-04-07", "2024-04-07", player_id = int(jarredkelenicID['key_mlbam'].values[0]))
...
def lookup_arcia(ti):
    ...
    orlandoarciaStats = statcast_batter("2024-04-07", "2024-04-07", player_id = int(orlandoarciaID['key_mlbam'].values[0]))
...
def combine_players(ti):
    ...
    orlandoarciaStats = ti.xcom_pull(task_ids='collect_players.lookup_arcia', key='orlandoarciaStats')
